...
<script>
    ...
    export default {
      ...
      methods: {
        ...
        mouseMove (event) {
          if (canDrag) {
            ...
            let mouseX = e.pageX
            let offsetLefet = this.$refs.duration.offsetLeft
            persentWidth = Math.floor((mouseX - offsetLefet) / this.$refs.duration.offsetWidth * 100)
            ...
            if (this.type === 'volume') {
              ...
              this.$refs.currentProgress.style.width = `cala(${persentWidth}%)`
              this.$refs.ball.style.left = `calc(${persentWidth}% - 7px)`
            }
          }
        },
      ...
      mounted () {
        ...
        this.$refs.ball.style.heigth = `${this.ballwidth}px`
