<template>
    <!--vue2.0废弃了1.0中使用transition属性，直接加入transition标签，transition只能有一个子节点，并且子节点必须有v-if v-show判断语句-->
    <transition name="sliderUpHideRight">
        <div class="musicdetail" v-show="isShowMusciDetail">
                        ...
                        <div class="cd">
                            ...
                            <div class="cd-content" ref="cdcontent">
                                <div class="wrapper" ref="cd" :class="isPlaying ? 'animate' : ''">
                                    <div class="cd-bg"></div>
                                    <img :src="getCurrentMusic.img_url" alt="" class="img">
                                </div>
                            </div>
                        </div>
                        <div class="musicDo">
